...
public class AreaMaker implements Iterable<Location> {
     ...
     */
    public AreaMaker(Location l1, Location l2) {
     ...
     */
    public AreaMaker(World world, int x1, int y1, int z1, int x2, int y2, int z2) {
     ...
     * @param z2        Z coord of corner 2
     */
    private AreaMaker(String worldName, int x1, int y1, int z1, int x2, int y2, int z2) {
     ...
     */
    public AreaMaker expand(CuboidDirection dir, int amount) {
        switch (dir) {
            case NORTH:
                return new AreaMaker(worldName, x1 - amount, y1, z1, x2, y2, z2);
            case SOUTH:
                return new AreaMaker(worldName, x1, y1, z1, x2 + amount, y2, z2);
            case EASY:
                return new AreaMaker(worldName, x1, y1, z1 - amount, x2, y2, z2);
            case WEST:
                return new AreaMaker(worldName, x1, y1, z1, x2, y2, z2 + amount);
            case DOWN:
                return new AreaMaker(worldName, x1, y1 - amount, z1, x2, y2, z2);
            case UP:
                return new AreaMaker(worldName, x1, y1, z1, x2, y2 + amount, z2);
            default:
                throw new IllegalArgumentException("invalid direction " + dir);
        }
    }
    public AreaMaker expandAll(int amount) {
        return new AreaMaker(worldName, x1 - amount, y1 - amount, z1 - amount, x2 + amount, y2 + amount, z2 + amount);
    }
     ...
     */
    public AreaMaker shift(CuboidDirection dir, int amount) {
     ...
     */
    private AreaMaker outset(CuboidDirection dir, int amount) {
        AreaMaker c;
        switch (dir) {
            case HORIZONTAL:
     ...
     */
	/*
	public AreaMaker inset(CuboidDirection dir, int amount) {
     ...
     */
    public AreaMaker getFace(CuboidDirection dir) {
        switch (dir) {
            case DOWN:
                return new AreaMaker(worldName, x1, y1, z1, x2, y1, z2);
            case UP:
                return new AreaMaker(worldName, x1, y2, z1, x2, y2, z2);
            case NORTH:
                return new AreaMaker(worldName, x1, y1, z1, x1, y2, z2);
            case SOUTH:
                return new AreaMaker(worldName, x2, y1, z1, x2, y2, z2);
            case EASY:
                return new AreaMaker(worldName, x1, y1, z1, x2, y2, z1);
            case WEST:
                return new AreaMaker(worldName, x1, y1, z2, x2, y2, z2);
            default:
                throw new IllegalArgumentException("Invalid direction " + dir);
        }
    }
     ...
     */
    public AreaMaker getBoundingAreaMaker(AreaMaker other) {
        if (other == null) {
            return this;
        }
        ...
        return new AreaMaker(worldName, xMin, yMin, zMin, xMax, yMax, zMax);
    }
